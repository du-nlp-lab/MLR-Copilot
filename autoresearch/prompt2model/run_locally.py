"""A script to run the autoresearch.prompt2model pipeline locally."""
from __future__ import annotations

import argparse

from autoresearch.prompt2model.dataset_generator import DatasetSplit, MockDatasetGenerator
from autoresearch.prompt2model.dataset_processor import MockProcessor
from autoresearch.prompt2model.dataset_retriever import MockRetriever
from autoresearch.prompt2model.demo_creator import mock_gradio_create
from autoresearch.prompt2model.model_evaluator import MockEvaluator
from autoresearch.prompt2model.model_executor import MockModelExecutor
from autoresearch.prompt2model.model_retriever import MockModelRetriever
from autoresearch.prompt2model.model_trainer import MockTrainer
from autoresearch.prompt2model.param_selector import MockParamSelector
from autoresearch.prompt2model.prompt_parser import MockPromptSpec, PromptSpec, TaskType
...
def run_skeleton(prompt_tokens: list[str], metrics_output_path: str) -> None:
    """Run the autoresearch.prompt2model pipeline locally using base/stub components."""
