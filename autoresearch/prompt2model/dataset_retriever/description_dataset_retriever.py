...
from autoresearch.prompt2model.dataset_retriever.base import DatasetInfo, DatasetRetriever
from autoresearch.prompt2model.dataset_retriever.column_selection_prompt import (
    construct_prompt_for_column_selection,
)
from autoresearch.prompt2model.dataset_retriever.reranking_prompt import (
...
from autoresearch.prompt2model.prompt_parser import PromptSpec
from autoresearch.prompt2model.utils import encode_text, get_formatted_logger, retrieve_objects
from autoresearch.prompt2model.utils.dataset_utils import get_dataset_size
from autoresearch.prompt2model.utils.parse_responses import parse_prompt_to_fields
    ...
    def initialize_search_index(self) -> None:
        ...
        if not os.path.exists(self.dataset_info_file):
            ...
            urllib.request.urlretrieve(
                "http://phontron.com/data/autoresearch.prompt2model/dataset_index.json",
        ...
        if not os.path.exists(self.reranking_dataset_info_file):
            ...
            urllib.request.urlretrieve(
                "http://phontron.com/data/autoresearch.prompt2model/reranking_dataset_index.json",
